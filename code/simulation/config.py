...
SIM = dict(
    ...
    timeout_sec=300.0,    # wall-clock cap per scenario: healthy scenarios take
                          #    ~2-10 s; a few high-density JuPedSim scenarios hang
                          #    indefinitely (observed: qp=75 combos, 17.5 h CPU),
                          #    so timed-out scenarios are recorded as FAILED
                          #    (conservative) instead of stalling the campaign.
)
